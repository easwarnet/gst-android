...
static void *app_function(void *userdata) {
    ...
    GST_DEBUG ("Creating pipeline %s in CustomData at %p", pipeline, data);
...
static void gst_native_init(JNIEnv *env, jobject thiz, jstring uri, jboolean credentials,
                            jstring username, jstring password) {
    CustomData *data = g_new0 (CustomData, 1);
    SET_CUSTOM_DATA (thiz, custom_data_field_id, data);
    GST_DEBUG_CATEGORY_INIT (debug_category, "rtspclient", 0, "Android tutorial 3");
