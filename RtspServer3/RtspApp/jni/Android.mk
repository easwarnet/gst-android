...
LOCAL_SRC_FILES := rtspclient.cpp
...
LOCAL_SRC_FILES := rtspservermain.cpp rtspserver.cpp
LOCAL_SHARED_LIBRARIES := gstreamer_android
LOCAL_LDLIBS := -llog -landroid
include $(BUILD_SHARED_LIBRARY)
...
GSTREAMER_EXTRA_DEPS      := gstreamer-video-1.0 gobject-2.0 gstreamer-rtsp-server-1.0 gstreamer-net-1.0
